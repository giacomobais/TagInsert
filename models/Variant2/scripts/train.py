...
from models.Variant2.scripts.preprocess import  load_data, get_atomic_labels, get_opaque_mapping, get_atomic_mapping, encode_CCG, get_positional_mapping, encode_trees, get_words_mapping, encode_words, get_splits, dataload_scan
from models.Variant2.model.utils import load_config, load_model, make_model, SimpleLossCompute, save_model
from models.Variant2.model.CCGNode import CCGNode, pretty_print_tree
from models.Variant2.model.model import TrainState
...
if __name__ == '__main__':
    ...
    path = 'models/Variant2/saved_models/Variant2'
    ...
    # save the model
    save_model(model, optimizer, lr_scheduler, train_losses, val_losses, trained_epochs, 'models/Variant2/saved_models/Variant2')
