...
from models.TagInsertL2R.scripts.preprocess import extract_BERT_embs, data_load, get_mapping_POS, get_mapping_words, get_splits, prepare_POS, prepare_words, get_bert_model
from models.TagInsertL2R.model.utils import load_config, greedy_decode
from models.TagInsertL2R.scripts.train import resume_training
...
if __name__ == "__main__":
    ...
    with open('models/TagInsertL2R/predictions/sample_predictions.txt', 'w') as file:
        for i in range(len(test_predictions)):
