...
from models.VanillaEncoderDecoderTransformer.model.model import make_model
import yaml
...
def load_config():
    ...
    """
    with open('models/VanillaEncoderDecoderTransformer/config/config.yaml', 'r') as file:
