...
from models.VanillaEncoderDecoderTransformer.scripts.preprocess import get_bert_model, get_mapping_POS, get_mapping_words
from models.VanillaEncoderDecoderTransformer.scripts.preprocess import data_load, prepare_POS, prepare_words, get_splits, dataload_scan
from models.VanillaEncoderDecoderTransformer.model.model import TrainState, make_model
from models.VanillaEncoderDecoderTransformer.model.utils import save_model, load_model, load_config, rate, SimpleLossCompute, LabelSmoothing    
  ...
  for i, batch in enumerate(data_iter):
      ...
      if i % 5 == 0:
          ...
          if i != 0 and mode == "train":
              save_model(model, optimizer, scheduler, [], [], 0, "models/VanillaEncoderDecoderTransformer/saved_models/VanillaTransformer_POS")
...
if __name__ == "__main__":
    ...
    path = "models/VanillaEncoderDecoderTransformer/saved_models/VanillaTransformer_POS"
