...
import torch
from models.Variant2.model.utils import greedy_decode, load_config
from models.Variant2.scripts.preprocess import load_data, get_atomic_mapping, get_words_mapping, get_opaque_mapping, get_splits, get_positional_mapping, get_atomic_labels, encode_CCG, encode_trees, encode_words
from models.Variant2.scripts.train import resume_training
...
if __name__ == "__main__":
    ...
    with open('models/Variant2/predictions/predictions.txt', 'w') as file:
